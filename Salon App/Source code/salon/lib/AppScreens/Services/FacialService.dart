...
class _FacialServiceState extends State<FacialService> {
  List<Map<String, dynamic>> facialService = [
    {
      'name': 'CleanUp',
      'image': 'assets/CleanUpFacial.jpg',
      'price': 1200,
      'description': 'A basic cleansing treatment that removes dirt, excess oil, and impurities to refresh your skin.',
      'duration': '25 mins',
    },
    {
      'name': 'Fruit Facial',
      'image': 'assets/FruitFacial.jpg',
      'price': 3500,
      'description': 'Infused with natural fruit extracts to deeply nourish, hydrate, and brighten dull skin.',
      'duration': '40 mins',
    },
    {
      'name': 'Glow Facial',
      'image': 'assets/GlowFacial.jpg',
      'price': 1500,
      'description': 'Gives your skin an instant boost of radiance, leaving it soft, fresh, and luminous.',
      'duration': '35 mins',
    },
    {
      'name': 'Gold/Diamond/Pearl Facial',
      'image': 'assets/GoldPearlFacial.jpg',
      'price': 4500,
      'description': 'A luxurious facial enriched with gold, diamond, or pearl extracts to rejuvenate and brighten.',
      'duration': '50 mins',
    },
    {
      'name': 'Brightening Facial',
      'image': 'assets/BrighteningFacial.jpg',
      'price': 3500,
      'description': 'Targets uneven skin tone, dullness, and dark spots for a visibly brighter complexion.',
      'duration': '55 mins',
    },
    {
      'name': 'Skin Whitening / De-tan',
      'image': 'assets/SkinWhitening.jpg',
      'price': 4500,
      'description': 'Reduces tanning, pigmentation, and sun damage while restoring natural fairness and glow.',
      'duration': '60 mins',
    },
    {
      'name': 'Vitamin C Facial',
      'image': 'assets/VitaminCFacial.jpg',
      'price': 2500,
      'description': 'Packed with Vitamin C to fade dark spots, improve texture, and leave skin visibly radiant.',
      'duration': '65 mins',
    },
  ...
  void initState() {
    ...
    for (var service in facialService) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemCount: facialService.length,
        itemBuilder: (context, index) {
          final service = facialService[index];
