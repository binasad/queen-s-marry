...
class AdminAllCandidatesScreen extends StatefulWidget {
  ...
  @override
  State<AdminAllCandidatesScreen> createState() => _AdminAllCandidatesScreenState();
}
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text("Course: ${candidate["course"]}",
                              style: const TextStyle(color: Colors.black)),
                          Text("Applied At: ${candidate["appliedAt"]}",
                              style: const TextStyle(color: Colors.black)),
                        ],
                      ),
                      trailing: Row(
                        ...
                        children: [
                          TextButton(
                            onPressed: () => _confirmAction(index, "Approve"),
                          ...
                          TextButton(
                            onPressed: () => _confirmAction(index, "Cancel"),
                            style: TextButton.styleFrom(
