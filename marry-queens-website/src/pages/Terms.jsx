                    ...
                    <div className="col-lg-10">
                        <div className="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white">
                            <div className="legal-content">
                                ...
                                <p>By accessing and using the Queen's Marry Beauty Salon website and mobile application, you agree to be bound by these Terms and Conditions. If you do not agree, please do not use our services.</p>
                                ...
                                <p>Payments for services, courses, or deals can be made online via our integrated payment gateways or in person at the salon. All online transactions are secure and encrypted.</p>
                                ...
                                <p>All content on this site, including images, text, and logos, is the property of Queen's Marry Beauty Salon and is protected by copyright laws. Unauthorized use is strictly prohibited.</p>

                                <h3 className="fw-bold mt-5 mb-4">6. Limitation of Liability</h3>
                                <p>Queen's Marry Beauty Salon is not liable for any direct, indirect, incidental, or consequential damages arising from the use of our website or services.</p>
