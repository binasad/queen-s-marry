...
class FacialTreatment extends StatefulWidget {
  const FacialTreatment({super.key});

  @override
  State<FacialTreatment> createState() => _FacialTreatmentState();
}

class _FacialTreatmentState extends State<FacialTreatment> {
  List<Map<String, dynamic>> facialTreatment = [

    {
      'name': 'Hydra Facial',
      'image': 'assets/HydraFacial.jpg',
      'price': 9000,
      'description': 'An advanced facial that deeply cleanses, exfoliates, hydrates, and infuses antioxidants for instantly radiant and refreshed skin.',
      'duration': '70 mins',
    },
    {
      'name': 'Serum Infusion',
      'image': 'assets/SerumInfusion.jpg',
      'price': 1000,
      'description': 'A quick yet powerful treatment that infuses high-performance serums to nourish, repair, and boost skin glow.',
      'duration': '40 mins',
    },
    {
      'name': 'Acne Treatment',
      'image': 'assets/AcneTreatment.jpg',
      'price': 5500,
      'description': 'Specialized therapy to control breakouts, reduce acne marks, calm irritation, and promote clearer skin.',
      'duration': '55 mins',
    },
    {
      'name': 'Anti-Aging Facial',
      'image': 'assets/AntiAgingFacial.jpg',
      'price': 2500,
      'description': 'Designed to fight fine lines and wrinkles while boosting collagen production for firmer, youthful-looking skin.',
      'duration': '65 mins',
    },
  ...
  void initState() {
    ...
    for (var service in facialTreatment) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemCount: facialTreatment.length,
        itemBuilder: (context, index) {
          final service = facialTreatment[index];
