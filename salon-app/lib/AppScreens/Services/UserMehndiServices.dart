...
class _MehndiServicesState extends State<MehndiServices> {
  List<Map<String, dynamic>> mehndiServices = [
    {
      'name': 'Hands',
      'image': 'assets/HandMehndi.png',
      'price': 500,
      'duration': '30–45 mins',
      'description':
      'Beautiful traditional mehndi applied on both palms with elegant patterns, perfect for festive occasions.',
    },
    {
      'name': 'Half Arm',
      'image': 'assets/HalfArm.jpg',
      'price': 1000,
      'duration': '60–90 mins',
      'description':
      'Stylish and detailed mehndi extending from palms to mid-arm, suitable for parties, Eid, or casual ceremonies.',
    },
    {
      'name': 'Full Arm',
      'image': 'assets/FullArmMehndi.png',
      'price': 1500,
      'duration': '2–3 hrs',
      'description':
      'Intricate mehndi designs covering from palms up to the elbow, giving a traditional and graceful bridal look.',
    },
    {
      'name': 'Foot Mehndi',
      'image': 'assets/FootMehndi.jpg',
      'price': 500,
      'duration': '45–60 mins',
      'description':
      'Delicate and creative mehndi patterns applied on the feet and ankles, enhancing the overall festive look.',
    },
    {
      'name': 'Bridal Mehndi',
      'image': 'assets/BridalMehndi.jpg',
      'price': 7500,
      'duration': '4–6 hrs',
      'description':
      'Customized, detailed bridal mehndi covering full hands and feet with intricate patterns, perfect for the wedding day.',
    },
  ...
  void sortServices(String type) {
    setState(() {
      sortType = type;
      if (type == 'name') {
        mehndiServices.sort((a, b) => a['name'].compareTo(b['name']));
      } else if (type == 'priceLowHigh') {
        mehndiServices.sort((a, b) => a['price'].compareTo(b['price']));
      } else if (type == 'priceHighLow') {
        mehndiServices.sort((a, b) => b['price'].compareTo(a['price']));
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemCount: mehndiServices.length,
        itemBuilder: (context, index) {
          final service = mehndiServices[index];
